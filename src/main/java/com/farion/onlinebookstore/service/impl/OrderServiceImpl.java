...
public class OrderServiceImpl implements OrderService {
    ...
    private Order saveOrder(CreateOrderRequestDto requestDto, Long id) {
        ...
        Order order = initOrder(cart, requestDto);
        setOrderItemsAndTotal(order, cart.getCartItems());
        return orderRepository.save(order);
    }

    private Order initOrder(ShoppingCart cart, CreateOrderRequestDto requestDto) {
    ...
    private void setOrderItemsAndTotal(Order order, Set<CartItem> cartItems) {
        Set<OrderItem> orderItems = itemService.createOrderItems(cartItems);
